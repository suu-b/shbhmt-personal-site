...
export default function Article(){
    ...
    return(
        <section className="article py-10">
            ...
            {description && (
                <p className="text-lg text-slate-400 mt-4 mb-6 leading-relaxed">{description}</p>
            )}
            ...
            {loading ? (
                ...
                <div className="font-light text-justify mt-5 leading-relaxed" dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(marked.parse(articleContent, { gfm: true, breaks: true })) }} />
            )}
        </section>
    )
}