        ...
        <section className="py-10">
            ...
            <div className="mt-10">
                {cardsData && cardsData.map((card, index) => (
                    <Link to={`/article/${contentType}/${card.date}/${card.title}`}>
                    <div key={index} className="card p-5 my-3 border border-slate-400 border-1 rounded-lg hover:cursor-pointer hover:bg-[#0F0E0E] hover:text-white transition-all duration-300 ease-in-out">
