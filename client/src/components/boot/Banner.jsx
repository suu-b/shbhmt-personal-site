...
export default function Banner() {
  ...
  const thumbnail =
    "https://upload.wikimedia.org/wikipedia/commons/b/b1/Caillebotte_-_Portrait_of_a_Man_Writing_in_His_Study%2C_1885.jpg";
  const alt =
    "Caillebotte - Portrait of a Man Writing in His Study 1885 from WikiMedia Commons";
  ...
  return (
    ...
    >
      ...
      >
        <img src={thumbnail} alt={alt} className="w-full h-64 object-cover" />
