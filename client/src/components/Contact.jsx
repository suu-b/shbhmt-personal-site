...
export default function Contact() {
    return (
        <section id="contact" className="w-full px-4 text-justify pb-10 mx-auto">
            <p className="mb-2">For a professional portfolio of me, refer to <Anchor text="this" link={"http://localhost:5000/pro"}/> link, or optionally, get a copy of my résumé <Anchor text="here" link={"http://localhost:5000/resume"}/> </p>
